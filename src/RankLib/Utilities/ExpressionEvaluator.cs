...
public class ExpressionEvaluator
{
	...
	private class Queue
	{
		...
		public void Enqueue(string s) => _list.Add(s);
	...
	private class Stack
	{
		...
		public void Push(string s) => _list.Add(s);
		...
		public override string ToString() => string.Join(" ", _list.ToArray());
	}
	...
	public string GetRPN(string expression) => ToPostFix(expression).ToString();
