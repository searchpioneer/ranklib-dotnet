...
public class Sorter
{
    ...
    /// <param name="asc">TRUE to sort ascendingly, FALSE to sort descendingly.</param>
    /// <returns>The sorted indexes.</returns>
    public static int[] Sort(int[] sortVal, bool asc)
    {
        return QSort(sortVal, asc);
    }

    public static int[] Sort(List<int> sortVal, bool asc)
    {
        return QSort(sortVal, asc);
    }

    public static int[] SortString(List<string> sortVal, bool asc)
    {
        return QSortString(sortVal, asc);
    }

    public static int[] SortLong(List<long> sortVal, bool asc)
    {
